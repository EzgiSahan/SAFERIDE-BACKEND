...
router.post('/', async(req, res) => {
    try {
        ...
        [req.body.name, req.body.surname, req.body.email, req.body.phone, req.body.password, req.body.role, req.body.country, req.body.city, req.body.address, req.body.birthdate]);
